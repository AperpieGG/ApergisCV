...
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent Join the team that has been selected as one of the top 6 entries for the Andor's Innovation Prize.
\end{itemize} 
...
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent \textit{"Assessing High-Precision Photometry with the Marana sCMOS Camera: I Lab Testing"}. Work complete, draft paper in preparation.
...
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    ...
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent \textit{O'Brien S. M. et al. (2023), "Planet Hunters NGTS: New Planet Candidates from a Citizen Science Search of the Next Generation Transit Survey Public Data"}.
