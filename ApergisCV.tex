...
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent I have been actively involved in the development team currently working on building the frame rate calculator application tailored for Sona/Marana camera products.
\end{itemize} 
\textbf{\large Studentship Physicist}| \normalfont{Andor Technology, Belfast} \hfill {\ \small May 2023 -- August 2023}
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent Member of the team that was Awarded Andor's Innovation Prize 2023 with work 'Anti-Glow correction on sCMOS sensors'.
\end{itemize} 
\textbf{\large Studentship Physicist}| \normalfont{Andor Technology, Belfast} \hfill {\ \small May 2024 -- October 2024}
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent Worked in various projects most importantly, for the new enhanced Sona-6 sCMOS for astronomical applications and in ChoiceMOS platform characterising various sensor types. 
\end{itemize} 
...
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    ...
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent \textit{"High-Precision Photometry with the Marana sCMOS Camera: II on-Sky Testing"}. Work complete, draft paper in preparation.
\end{itemize}
\vspace{-2pt}
...
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    ...
    Photo-dynamical characterisation of the TOI-178 resonant chain. Exploring the robustness of TTV and RV mass characterisation"}, (submitted in A\&A).
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent
    \textit{Alves D. et al. (2024). "
    NGTS-33b: A Young Super-Jupiter Hosted by a Fast Rotating
    Massive Hot Star"}, (to be submitted in MNRAS)
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent
    \textit{Rodel T. et al. (2024). "
    TIC 238060327, an eccentric, long-period, low-mass eclipsing binary from TESS and NGTS"}, (to be submitted in MNRAS)
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent
    \textit{Essack T. et al. (2024). "
    Giant Outer Transiting Exoplanet Mass (GOT ‘EM) Survey. VI: Confirmation of a Long-Period
    Giant Planet Discovered with a Single TESS Transit"}, (to be submitted in A\&A)
\end{itemize}
...
\end{itemize} 
\textbf{\large NGTS Consortium Meeting}| \normalfont{University of Warwick (Online)} \hfill { \small April 2024}
\\[-0.5cm]

\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent Presented my work and involvement with Andor
\end{itemize} 
\textbf{\large NGTS Consortium Meeting}| \normalfont{University of Geneva} \hfill { \small Sep 2024}
\\[-0.5cm]
...
\end{itemize} 
\textbf{\large Paranal Observatory} \hfill {\ \small Dec 2023}
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent I took part in a technical mission to the NGTS telescopes at Paranal observatory to mount the CMOS camera. 
\end{itemize} 
...
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent Outreach participation about an astrophysicist designed program introducing coding to kids.
\end{itemize}
 \textbf{\large{Warwick Astronomy Society}} \hfill {\ \small Nov 2023}
\\[-0.6cm]
\begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
    \item[{\color[RGB]{10,0,254}$\bullet$}] \noindent Gave a talk on Warwick's Astronomy Society about scientific cameras.
\end{itemize}
